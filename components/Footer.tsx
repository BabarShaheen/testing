...
export function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="bg-navy-blue text-white relative overflow-hidden">
      ...
      <div className="absolute bottom-20 left-10 w-16 h-16 bg-orange/10 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="animate-fade-in-up">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-white">Citrix Consulting Services</h3>
            </div>
            <p className="text-gray-300 mb-4 leading-relaxed">
              Professional compliance and safety solutions for businesses across the UK. 
              Helping you achieve regulatory excellence.
            </p>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.page} className="animate-fade-in-up" style={{ animationDelay: `${0.2 + index * 0.05}s` }}>
                  <button
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={service.id} className="animate-fade-in-up" style={{ animationDelay: `${0.3 + index * 0.05}s` }}>
                  <button
      ...
      <div className="border-t border-gray-700 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="mt-4 md:mt-0 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              <div className="flex space-x-4">
                {[
                  { page: 'policies', label: 'Privacy Policy' },
                  { page: 'policies', label: 'Terms & Conditions' }
                ].map((link, index) => (
                  <button
                    key={index}
                    onClick={() => handleNavClick(link.page)}
      ...
      <button
        ...
        className={`fixed bottom-8 right-8 w-12 h-12 bg-orange hover:bg-orange/90 text-white rounded-full shadow-lg transition-all duration-300 hover-lift z-50 ${
          showScrollTop ? 'animate-fade-in-up opacity-100' : 'opacity-0 pointer-events-none'
        }`}
      >
