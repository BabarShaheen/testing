      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-3xl font-bold text-navy-blue mb-6">Send us a Message</h2>
            ...
            {/* Contact Information */}
            <div>
              <h2 className="text-3xl font-bold text-navy-blue mb-6">Get in Touch</h2>
              <p className="text-lg text-gray-600 mb-8">
                We're here to help you achieve compliance excellence. Contact us using any of the methods below.
              </p>
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="font-semibold text-navy-blue">Business Hours</h3>
              ...
              <Card className="border-none shadow-lg bg-gray-50">
                <CardHeader>
                  <CardTitle className="text-teal-dark">Free Consultation</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 mb-4">
                    Not sure which service you need? Book a free 30-minute consultation with one of our experts.
                  </p>
