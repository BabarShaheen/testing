...
import { CheckCircle, Clock, Star, Users, Award, ArrowLeft } from 'lucide-react';
...
export function ServiceDetailPage({ serviceId, onNavigate }: ServiceDetailPageProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    alert(`Thank you for your quote request for ${service?.title}! We will contact you within 24 hours.`);
    setFormData({
      name: '',
      email: '',
      company: '',
  ...
  const handleRelatedServiceClick = (relatedServiceId: string) => {
    if (onNavigate) {
      onNavigate('service-detail', relatedServiceId);
    }
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center py-20">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-navy-blue mb-2">Service Not Found</h2>
  ...
  return (
    <div className="min-h-screen py-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center mb-4">
                ...
                <Badge variant="secondary" className="bg-leaf-green text-white ml-4">
                  {service.badge}
                </Badge>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                <div className="grid grid-cols-2 gap-6 text-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-100">{service.stats.successRate}</div>
                  </div>
                  <div>
                    <Star className="h-8 w-8 text-orange mx-auto mb-2" />
                    <div className="text-lg font-semibold">Client Rating</div>
                    <div className="text-gray-100">{service.stats.clientRating}</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-navy-blue mb-4">Key Benefits</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-navy-blue mb-4">Our Process</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              ...
              <Card key={index} className="border-none shadow-lg">
                <CardHeader>
                  <div className="flex items-center mb-4">
                    ...
                    <CardTitle className="text-teal-dark">{step.title}</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
      ...
      <section id="quote-form" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-navy-blue mb-4">Request a Quote</h2>
              <p className="text-lg text-gray-600 mb-8">
                Get a personalized quote for your {service.title} project. Our team will contact you within 24 hours.
              </p>
            ...
            <div>
              <h3 className="text-xl font-semibold text-navy-blue mb-6">Related Services</h3>
              <div className="space-y-4">
                {service.relatedServices.map((relatedService, index) => (
                  <Card key={index} className="border-none shadow-sm cursor-pointer">
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <h4 className="font-semibold text-teal-dark">{relatedService.name}</h4>
