...
import { CheckCircle, Shield, Award, FileText, Users, Leaf, Target, Clock } from 'lucide-react';
      ...
      <section className="bg-teal-gradient text-white py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <p className="text-xl text-gray-100 max-w-3xl mx-auto">
            Comprehensive compliance and safety solutions designed to help your business meet regulatory requirements 
                ...
                >
                  <CardHeader className="text-center">
                    ...
                    <div className="flex items-center justify-center gap-2 mb-2">
                      ...
                      <Badge variant="secondary" className="bg-leaf-green text-white">
                        {service.badge}
                      </Badge>
                    </div>
                  </CardHeader>
                  <CardContent>
                    ...
                    <div className="mb-4">
                      <h4 className="font-semibold text-navy-blue mb-2">Key Features:</h4>
                    ...
                    <div className="mb-4 p-3 bg-white/60 rounded-lg border border-gray-200">
                      ...
                      <p className="font-semibold text-teal-dark">{service.pricing}</p>
                    </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-navy-blue mb-4">Additional Services</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We also provide specialized consulting services tailored to your specific industry needs
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: "Construction Safety", desc: "Specialized safety consulting for construction projects" },
              { name: "Food Safety", desc: "HACCP and food safety management systems" },
              { name: "Data Protection", desc: "GDPR compliance and data protection audits" },
              { name: "Training Programs", desc: "Customized training for your staff and management" },
              { name: "Compliance Audits", desc: "Regular compliance audits and assessments" },
              { name: "Emergency Planning", desc: "Business continuity and emergency response planning" }
            ].map((additional, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                <h3 className="font-semibold text-teal-dark mb-2">{additional.name}</h3>
      ...
      <section className="py-16 bg-teal-gradient text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <p className="text-xl text-gray-100 max-w-2xl mx-auto mb-8">
            Our expert team can create a tailored compliance solution specifically for your business needs.
          </p>
