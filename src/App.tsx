    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        <AnimatePresence mode="wait">
          ...
          <Route path="/services/:serviceId" element={<PageTransition><SafetyAdviserPage /></PageTransition>} />

          {/* Safety Adviser Routes */}
          <Route
            path="/services/safety-adviser"
            element={<PageTransition><SafetyAdviserPage /></PageTransition>}
          />
          <Route
            path="/services/safety-advisor/health-safety"
            element={<PageTransition><HealthSafetyPage /></PageTransition>}
          />

          <Route
            path="/services/safety-advisor/chas-assistance"
            element={<PageTransition><ChasAssistancePage /></PageTransition>}
          />

          {/* SIA Contractor Routes */}
          <Route
            path="/services/sia-contractor"
            element={<PageTransition><SiaContractorPage /></PageTransition>}
          />
          <Route path="/services/sia-acs" element={<PageTransition><SiaAcsPage /></PageTransition>} />
          <Route
            path="/services/sia-contractor/acs-audit"
            element={<PageTransition><AcsCompliancePage /></PageTransition>}
          />
          <Route
            path="/services/sia-contractor/acs-eligibility"
            element={<PageTransition><AcsEligibilityPage /></PageTransition>}
          />

          {/* ISO Certifications Routes */}
          <Route
            path="/services/iso-certifications"
            element={<PageTransition><IsoCertificationsPage /></PageTransition>}
          />
          <Route
            path="/services/iso-certifications/iso-9001"
            element={<PageTransition><Iso9001Page /></PageTransition>}
          />
          <Route
            path="/services/iso-certifications/iso-14001"
            element={<PageTransition><Iso14001Page /></PageTransition>}
          />
          <Route path="/iso-14001" element={<PageTransition><Iso14001Page /></PageTransition>} />

          <Route
            path="/services/iso-certifications/sia-acs-integration"
            element={<PageTransition><SiaAcsPage /></PageTransition>}
          />
          <Route path="/services/iso-certifications/ohsas-18001" element={<PageTransition><OHSAS18001Page /></PageTransition>} />

          {/* Other Services Routes */}
          <Route
            path="/services/staff-vetting"
            element={<PageTransition><StaffVettingPage /></PageTransition>}
          />
          <Route path="/services/pat-testing" element={<PageTransition><PatTestingPage /></PageTransition>} />
          <Route
            path="/services/fire-safety"
            element={<PageTransition><FireSafetyCertificationPage /></PageTransition>}
          />
          <Route
            path="/services/risk-assessments"
            element={<PageTransition><RiskAssessmentsPage /></PageTransition>}
          />
          <Route
            path="/services/bafe-certification"
            element={<PageTransition><BafeCertificationPage /></PageTransition>}
          />
          <Route
            path="/services/smas-accreditation"
            element={<PageTransition><SmasAccreditationPage /></PageTransition>}
          />
          <Route
            path="/services/acclaim-accreditation"
            element={<PageTransition><AcclaimAccreditationPage /></PageTransition>}
          />
          <Route
            path="/services/constructionline-accreditation"
            element={<PageTransition><ConstructionlineAccreditationPage /></PageTransition>}
          />
          ...
          <Route
            ...
            element={<PageTransition><SSIPAccreditationPage /></PageTransition>}
          />
          <Route path="/about/policies" element={<PageTransition><PoliciesPage /></PageTransition>} />
          <Route path="/about/insurance" element={<PageTransition><InsurancePage /></PageTransition>} />
          <Route path="/about/careers" element={<PageTransition><CareersPage /></PageTransition>} />
          <Route path="/about/" element={<PageTransition><CareersPage /></PageTransition>} />
