        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              At <strong>Citrix Consultancy Services</strong>, we hold the appropriate insurance coverage to ensure safety, compliance, and peace of mind for our clients.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              <CardContent className="p-6">
                  ...
                  {[
                    {
                      ...
                      amount: '£5,000,000',
                      description: 'Comprehensive protection for third-party claims'
                    },
                    {
                      icon: FileText,
                    ...
                    <div key={index} className="text-center p-6 bg-gradient-to-br from-gray-50 to-white rounded-lg border border-gray-100 hover:border-teal-dark/20 transition-all duration-300">
                      ...
                      <h3 className="text-lg font-semibold text-teal-dark mb-2">{coverage.title}</h3>
                      <div className="text-3xl font-bold text-orange mb-2">{coverage.amount}</div>
                ...
                <div className="mt-6 p-4 bg-teal-light/10 rounded-lg border-l-4 border-teal-dark">
                  <p className="text-gray-700 leading-relaxed">
                    This comprehensive insurance allows us to confidently deliver consulting services across industries with full assurance of legal and operational compliance.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="space-y-6">
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-bold text-teal-dark mb-2">CiTRiX Consultancy Services Ltd</h3>
                    <p className="text-gray-600">Company Number: <span className="font-semibold text-teal-dark">SC472028</span></p>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-teal-dark">272 Bath Street, Glasgow, Scotland, G2 4JR</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-teal-dark">02085755544</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-teal-dark">07446131794</p>
                        </div>
                      </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <CardContent className="p-6">
                <p className="text-gray-700 text-sm leading-relaxed mb-4">
                  Have questions about our insurance coverage or need to discuss your project requirements?
                </p>
                <div className="space-y-3">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <CardContent className="p-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-orange mb-2">£20M</div>
