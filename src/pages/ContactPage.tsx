                ...
                <div className="p-6 bg-white">
                  <div className="space-y-4">
                    ...
                    <div className="bg-gradient-to-r from-warm-amber/10 to-crimson-pink/10 p-4 rounded-lg border border-warm-amber/20">
                      <h4 className="font-semibold text-charcoal-navy mb-2">What happens next?</h4>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            >
              <div className="mb-8">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  Complete the form below and we'll respond within 24 hours. Our expert team is ready to help with all your compliance and safety needs.
                </p>
              </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <Label htmlFor="name" className="text-sm font-semibold text-charcoal-navy">
                          Full Name *
                        </Label>
                        <Input
                          id="name"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="email" className="text-sm font-semibold text-charcoal-navy">
                          Email Address *
                        </Label>
                        <Input
                          id="email"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <Label htmlFor="company" className="text-sm font-semibold text-charcoal-navy">
                          Company Name
                        </Label>
                        <Input
                          id="company"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="phone" className="text-sm font-semibold text-charcoal-navy">
                          Phone Number
                        </Label>
                        <Input
                          id="phone"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="service" className="text-sm font-semibold text-charcoal-navy">
                        Service of Interest
                      </Label>
                      <Input
                        id="service"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="message" className="text-sm font-semibold text-charcoal-navy">
                        Message *
                      </Label>
                      <Textarea
                        id="message"
                    ...
                    <div className="flex items-start gap-3 p-4 bg-soft-lavender-grey/30 rounded-xl">
                      ...
                      >
                        ...
                        <span className="text-crimson-pink font-semibold hover:underline">privacy policy</span>.
                      </Label>
                    </div>
            ...
            >
              <div className="mb-8">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  We're here to help with all your compliance and safety needs. Reach out to us through any of the channels below.
                </p>
              </div>
                  ...
                  <CardContent className="p-6 sm:p-8 text-white">
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-pure-white/90">Expert compliance consultants with 15+ years experience</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-crimson-pink rounded-full mt-2 flex-shrink-0"></div>
                        <span className="text-pure-white/90">Fast response times - typically within 2 hours</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-crimson-pink rounded-full mt-2 flex-shrink-0"></div>
                        <span className="text-pure-white/90">Proven track record with 500+ successful projects</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-crimson-pink rounded-full mt-2 flex-shrink-0"></div>
                        <span className="text-pure-white/90">Competitive pricing with transparent quotes</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-crimson-pink rounded-full mt-2 flex-shrink-0"></div>
                        <span className="text-pure-white/90">Full compliance with UK regulations and standards</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
