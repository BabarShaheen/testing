...
import { constructionlineServices, constructionlineBenefits, processSteps, statsData } from '../../data/constructionlineAccreditationData';
import { SectionHeader } from '../../components/common';

export function ConstructionlineAccreditationPage() {
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-start overflow-hidden bg-[#1C1F2A] text-white px-6 sm:px-12 lg:px-20">
        ...
        <motion.div
          ...
          transition={{
            duration: 8,
            repeat: Infinity,
            ease: cubicBezier(0.4, 0, 0.2, 1), // Using cubic-bezier for easeInOut
          }}
        />
        <motion.div
        ...
        >
          ...
          <motion.p 
            ...
            variants={fadeInUp}
          >
            Achieve Constructionline accreditation with our expert guidance and support. We help you navigate the entire process from initial assessment to successful certification.
          </motion.p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <SectionHeader
              title={<>Constructionline <span className="text-crimson-pink animate-gradient">Accreditation</span> Services</>}
              description="Comprehensive support for achieving Constructionline accreditation"
            />
          </motion.div>
          ...
          <motion.div 
            ...
            variants={staggerContainer}
          >
            {constructionlineServices.map((service, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <SectionHeader
              ...
              description="How we help you achieve Constructionline accreditation"
            />
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <SectionHeader
              ...
              description="Why choose Constructionline accreditation for your business"
            />
          </motion.div>
          ...
          <motion.div 
            ...
            variants={staggerContainer}
          >
            {constructionlineBenefits.map((benefit, index) => (
              <motion.div 
                key={index} 
                variants={cardVariants}
      ...
      <section className="py-20 bg-gradient-to-r from-[#ED2568] to-[#EE343B] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.h2 
            ...
            transition={{ duration: 0.8 }}
          >
            Ready to achieve Constructionline accreditation?
          </motion.h2>
          <motion.p 
