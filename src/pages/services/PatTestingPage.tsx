        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center space-y-8">
          ...
          <div className="flex justify-center mb-6">
            <div className="p-6 bg-pure-white/10 rounded-full shadow-2xl backdrop-blur-sm border border-soft-lavender-grey/20">
              <Zap className="h-20 w-20 text-pure-white" />
            </div>
          </div>

          {/* Title */}
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold leading-tight">
            <span className="text-pure-white block">PAT Testing</span>
            <span className="text-gradient-crimson block">Services</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            <div className="bg-pure-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-soft-lavender-grey/20">
              <span className="text-pure-white font-medium">
                Professional Testing
              </span>
            </div>
            <div className="bg-pure-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-soft-lavender-grey/20">
              <span className="text-pure-white font-medium">Full Certification</span>
            </div>
            <div className="bg-pure-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-soft-lavender-grey/20">
              <span className="text-pure-white font-medium">Legal Compliance</span>
            </div>
          </div>
