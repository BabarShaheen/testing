    ...
    <div className="min-h-screen">
      ...
      <section className="min-h-screen relative flex items-center justify-center bg-[#1C1F2A] text-white px-6 sm:px-12 lg:px-20 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/Images/services/45001.webp')",
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center space-y-8">
          ...
          <p className="text-2xl sm:text-3xl text-[#f57aa9] font-semibold">
            Protect Your Workforce with Certified Safety Management
          </p>

          {/* Description */}
          <p className="text-xl text-gray-200 max-w-4xl mx-auto leading-relaxed">
            Our OHSMS Consultancy helps you establish, implement, and maintain a
            comprehensive Occupational Health and Safety Management System.
            Create safer workplaces and achieve international recognition.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              ...
              management systems protecting workers worldwide
            </p>
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ISO 45001 protects employees and visitors from
                      work-related accidents and diseases through systematic
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      safety providing practical solutions for worker safety
                      globally.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-white to-[#fce8ef] p-8 rounded-2xl shadow-2xl border border-[#f57aa9] relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4">
                  {healthSafetyFocusAreas.map((area, idx) => (
                    <div
                      key={idx}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Essential components of an effective Occupational Health and
              Safety Management System
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {ohsmsElements.map((element, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-[#fce8ef] to-[#fff0f5] p-6 rounded-2xl border border-[#f57aa9] shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group"
              >
                <div className="text-center">
                  <div className="w-12 h-12 mx-auto mb-4 rounded-full flex items-center justify-center bg-gradient-to-br from-[#ED2568] to-[#EE343B] shadow-lg text-white group-hover:scale-110 transition-transform duration-300">
                    <element.icon className="w-6 h-6" />
                  </div>
                  <h3 className="text-lg font-bold text-slate-800 mb-2 group-hover:text-[#ED2568] transition-colors">
                    {element.title}
                  </h3>
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-[#fce8ef]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive safety measures protecting your workforce and
              workplace
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {keySafetyControls.map((control, index) => (
              <div
                key={index}
                className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group border border-gray-100"
              >
                <div className="text-center">
                  <div className="w-12 h-12 mx-auto mb-4 rounded-full flex items-center justify-center bg-gradient-to-br from-[#ED2568] to-[#EE343B] shadow-lg text-white group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-[#fce8ef] to-[#fff0f5] p-8 rounded-2xl border border-[#f57aa9] shadow-xl">
              ...
              <div className="space-y-4">
                {safetyPerformanceMetrics.map((item, idx) => (
                  <div
                    key={idx}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold mb-4">
              Our OHSMS Implementation Process
            </h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Systematic approach to achieving ISO 45001 certification with
              guaranteed workplace safety excellence
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-[#fce8ef]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-slate-800 mb-4">
              Why Choose Our Health & Safety Consultancy?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Specialized expertise in workplace safety with proven track record
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive certification process ensuring occupational health
              and safety management excellence
            </p>
          </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-extrabold mb-6">
            Build a Safer Workplace with ISO 45001
          </h2>

          <p className="text-xl text-gray-100 max-w-3xl mx-auto mb-10">
            Join thousands of organizations worldwide who have transformed their
            workplace safety culture with our expert ISO 45001 implementation.
            Protect your workers, reduce costs, and achieve excellence.
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 max-w-4xl mx-auto shadow-2xl">
            <div className="grid md:grid-cols-4 gap-6 text-center">
              ...
              <div>
                ...
                <p className="text-gray-200">Workplaces Protected</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-gray-200">Accident Reduction</p>
              </div>
            </div>
          </div>
        </div>
