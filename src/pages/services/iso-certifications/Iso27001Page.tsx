    ...
    <div className="min-h-screen">
      ...
      <section className="min-h-screen relative flex items-center justify-center bg-[#1C1F2A] text-white px-6 sm:px-12 lg:px-20 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/Images/services/27001.webp')",
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center space-y-8">
          ...
          <p className="text-2xl sm:text-3xl text-[#f57aa9] font-semibold">
            Protect Your Digital Assets with Certified Security
          </p>

          {/* Description */}
          <p className="text-xl text-gray-200 max-w-4xl mx-auto leading-relaxed">
            Our ISMS Consultancy helps you establish, implement, and maintain a
            comprehensive Information Security Management System. Protect your
            organization from cyber threats and achieve international
            certification.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              The international standard for establishing, implementing, and
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ISO 27001 provides a systematic approach to managing
                      sensitive company information, ensuring it remains secure
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      providing credibility and competitive advantage in global
            ...
            <div className="bg-gradient-to-br from-white to-[#fce8ef] p-8 rounded-2xl shadow-2xl border border-[#f57aa9] relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4">
                  {informationSecurityFocusAreas.map((area, idx) => (
                    <div
                      key={idx}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive security measures protecting your organization's
              critical information assets
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {keySecurityControls.map((control, index) => (
              <div
                key={index}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-[#fce8ef] to-[#fff0f5] p-8 rounded-2xl border border-[#f57aa9] shadow-xl">
              ...
              <div className="space-y-4">
                {securityRiskReduction.map((item, idx) => (
                  <div
                    key={idx}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold mb-4">
              Our ISMS Implementation Process
            </h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Systematic approach to achieving ISO 27001 certification with
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-slate-800 mb-4">
              Why Choose Our Information Security Consultancy?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Specialized expertise in cyber security with proven track record
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-[#fce8ef]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive certification process ensuring information security
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-extrabold mb-6">
            Secure Your Digital Future with ISO 27001
          </h2>

          <p className="text-xl text-gray-100 max-w-3xl mx-auto mb-10">
            Join hundreds of organizations worldwide who have strengthened their
            cyber security posture with our expert ISO 27001 implementation.
            Protect your business, build customer trust, and achieve compliance.
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 max-w-4xl mx-auto shadow-2xl">
            <div className="grid md:grid-cols-4 gap-6 text-center">
              ...
              <div>
                ...
                <p className="text-gray-200">Clients Secured</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-gray-200">Security Support</p>
              </div>
            </div>
          </div>
        </div>
