            ...
            <div className="max-w-3xl text-left space-y-10">
              ...
              <div className="flex flex-col sm:flex-row gap-6 pt-4">
                <button
                  ...
                  className="bg-crimson-gradient hover:bg-vivid-red text-pure-white px-10 py-4 rounded-xl text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl group relative overflow-hidden"
                >
