...
import {
  ...
  constructionlineBenefits,
  processSteps,
} from '../../../data/constructionlineAccreditationData';
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-start overflow-hidden bg-[#1C1F2A] text-white px-6 sm:px-12 lg:px-20">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/Images/services/construction.webp')",
        ...
        >
          ...
          <motion.p
            ...
            variants={fadeInUp}
          >
            Achieve Constructionline accreditation with our expert guidance and
            support. We help you navigate the entire process from initial
