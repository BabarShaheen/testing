...
export default function BafeSP205Page() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-charcoal-navy text-pure-white px-6 sm:px-12 lg:px-20">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8">
          {/* Badge */}
          <div className="inline-block bg-crimson-pink/10 text-crimson-pink font-semibold tracking-wide px-5 py-2 rounded-full text-sm shadow-md">
            BAFE SP205 Certification
          </div>

          {/* Title */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight text-pure-white">
            Life Safety Fire Risk Assessment Consultancy
          </h1>

          {/* Description */}
          <p className="text-lg sm:text-xl text-soft-lavender-grey/80 max-w-4xl mx-auto leading-relaxed">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-4xl mx-auto border border-white/20 shadow-lg">
            <div className="flex items-center justify-center mb-6">
              <Shield className="h-12 w-12 text-crimson-pink mr-4" />
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-4">
            <button
              ...
              className="bg-gradient-to-r from-crimson-pink to-crimson-red text-white px-8 py-3 text-lg font-semibold rounded-xl shadow-lg hover:brightness-110 transition-all flex items-center"
            >
      ...
      <div id="main-content">
        ...
        <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-100 relative">
          <div className="absolute top-0 left-0 w-full h-64 bg-gradient-to-r from-crimson-pink/10 to-crimson-red/10 pointer-events-none" />

          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-charcoal-navy mb-6">
              ...
              {consultancySteps.map((stepItem, index) => (
                ...
                >
                  <div className="flex-1">
                    <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300">
                      <div className="flex items-center mb-6">
                        <div className="w-16 h-16 bg-gradient-to-r from-crimson-pink to-crimson-red rounded-full flex items-center justify-center text-white mr-6 shadow-lg">
                          <stepItem.icon className="w-8 h-8" />
                        </div>
                        <div>
                          <div className="text-sm font-medium text-crimson-pink mb-1 uppercase tracking-wide">
                            {stepItem.step}
                          </div>
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-24 h-24 bg-gradient-to-r from-crimson-pink to-crimson-red rounded-full flex items-center justify-center text-white text-3xl font-bold shadow-xl">
                      {index + 1}
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={index} className="flex items-start">
                      <CheckCircle className="h-6 w-6 text-crimson-pink mr-4 mt-1 flex-shrink-0" />
                      <div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-xl border border-gray-100">
                <div className="text-center mb-8">
                  <div className="w-16 h-16 bg-gradient-to-r from-crimson-pink to-crimson-red rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center py-3 border-b border-gray-200">
                    ...
                    <span className="font-bold text-crimson-pink text-lg">
                      £2,800
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-gray-200">
                    <span className="text-gray-600 font-medium">Timeline:</span>
                    <span className="font-bold text-charcoal-navy">6-8 weeks</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-gray-200">
                    <span className="text-gray-600 font-medium">
                      Success Rate:
                    </span>
                    <span className="font-bold text-crimson-pink">92%</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-gray-200">
                    <span className="text-gray-600 font-medium">
                      Clients Served:
                    </span>
                    <span className="font-bold text-charcoal-navy">60+</span>
                  </div>
                                      <div className="pt-6">
                      <div className="text-center">
                        <div className="inline-block bg-gradient-to-r from-crimson-pink to-crimson-red text-white px-4 py-2 rounded-full font-semibold text-sm mb-4">
                ...
                <button
                  className="w-full mt-8 bg-gradient-to-r from-crimson-pink to-crimson-red text-white px-6 py-3 rounded-xl font-semibold hover:brightness-110 transition-all shadow-lg"
                  onClick={handleContactClick}
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {Benefits.map((item, index) => (
                ...
                >
                  <div className="w-16 h-16 bg-gradient-to-r from-crimson-pink to-crimson-red rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                    <item.icon className="text-white w-8 h-8" />
                  </div>
                  <h3 className="text-xl font-semibold text-charcoal-navy mb-4">
                    {item.title}
                  </h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div
                  key={index}
                  className="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg hover:shadow-xl hover:border-crimson-pink transition-all duration-300 text-center group"
                >
                  <div className="w-14 h-14 bg-gradient-to-r from-crimson-pink to-crimson-red rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform">
                    <item.icon className="h-7 w-7 text-white" />
                  </div>
                  <h3 className="font-semibold text-charcoal-navy mb-3 text-lg">
                    {item.title}
                  </h3>
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
                          <button
              className="bg-gradient-to-r from-crimson-pink to-crimson-red hover:from-crimson-pink/90 hover:to-crimson-red/90 text-white px-8 py-4 rounded-xl text-lg font-semibold shadow-2xl transition-all duration-300 transform hover:scale-105"
              onClick={handleContactClick}
            >
              Get Free Consultation
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 max-w-4xl mx-auto shadow-2xl">
              <div className="grid md:grid-cols-3 gap-6 text-center">
                ...
                <div>
                  <div className="text-3xl font-bold text-crimson-red mb-2">
                    5-7
                  </div>
