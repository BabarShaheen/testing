...
import { acclaimServices, acclaimBenefits, processSteps, statsData } from '../../data/acclaimAccreditationData';
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-start overflow-hidden bg-[#1C1F2A] text-white px-6 sm:px-12 lg:px-20">
        ...
        >
          ...
          <motion.p 
            ...
            variants={fadeInUp}
          >
            Achieve Acclaim accreditation with our expert guidance and support. We help you navigate the entire process from initial assessment to successful certification.
          </motion.p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <SectionHeader
              title={<>Acclaim <span className="text-crimson-pink animate-gradient">Accreditation</span> Services</>}
